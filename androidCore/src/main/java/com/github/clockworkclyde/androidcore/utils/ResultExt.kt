...
import com.github.clockworkclyde.androidcore.common.FlowResult
import com.github.clockworkclyde.androidcore.common.FlowResultList
import com.github.clockworkclyde.androidcore.common.InHandler
import com.github.clockworkclyde.androidcore.common.ResultList
...
inline fun <reified T : Any> DResult<T>.applyIfSuccess(block: InHandler<T>): DResult<T> {
   if (this is DResult.Success) block(this.data)
   return this
}

inline fun <reified T : Any> DResult<T>.applyIfError(block: InHandler<DResult.ResultThrowable>): DResult<T> {
